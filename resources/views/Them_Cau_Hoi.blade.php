                        ...
                        <div class="card-box">
                            ...
                            <form action="#" class="parsley-examples" novalidate="" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="noidung" parsley-trigger="change" required="" placeholder="Enter user name" class="form-control" id="userName">
                                ...
                                <div class="form-group mt-1 dropdown bootstrap-select">
                                   <label for="userName">Lĩnh Vực<span class="text-danger">*</span></label>
                                    ...
                                    <input type="text" name="phuongana" parsley-trigger="change" required="" placeholder="Enter user name" class="form-control" id="userName">
                                    <label for="userName">Phương án B<span class="text-danger">*</span></label>
                                    <input type="text" name="phuonganb" parsley-trigger="change" required="" placeholder="Enter user name" class="form-control" id="userName">
                                    <label for="userName">Phương án C<span class="text-danger">*</span></label>
                                    <input type="text" name="phuonganc" parsley-trigger="change" required="" placeholder="Enter user name" class="form-control" id="userName">
                                    <label for="userName">Phương án D<span class="text-danger">*</span></label>
                                    <input type="text" name="phuongand" parsley-trigger="change" required="" placeholder="Enter user name" class="form-control" id="userName">
                                    <label for="userName">Đáp Án<span class="text-danger">*</span></label>
                                    <input type="text" name="dapan" parsley-trigger="change" required="" placeholder="Enter user name" class="form-control" id="userName">
                             	</div>
