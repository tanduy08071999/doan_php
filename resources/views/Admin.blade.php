...
<html lang="en">
    <head>
        ...
        <!-- third party css end -->
        <!-- App css -->
        <link href="{{asset('assets/css/bootstrap.min.css')}}""s" rel="stylesheet" type="text/css" />
        <link href="{{asset('assets/css/icons.min.css')}}""s" rel="stylesheet" type="text/css" />
        <link href="{{asset('assets/css/app.min.css')}}""s" rel="stylesheet" type="text/css" />
